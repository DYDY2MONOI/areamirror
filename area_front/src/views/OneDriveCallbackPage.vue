      ...
      <div class="callback-card">
        <div class="callback-header">
          <div class="logo-container">
            <v-icon size="48" color="primary">mdi-microsoft-onedrive</v-icon>
          </div>
          <h1 class="callback-title">OneDrive Authentication</h1>
        ...
        <div class="success-container" v-if="success">
          ...
          <p class="success-text">OneDrive account linked successfully!</p>
          <v-btn
            @click="redirectToProfile"
            color="primary"
            class="mt-4"
...
const message = ref('Processing OneDrive authentication...')
...
onMounted(async () => {
  try {
    ...
    if (errorParam) {
      throw new Error('OneDrive authentication was cancelled or failed')
    }
    ...
    success.value = true
    loading.value = false
    message.value = 'OneDrive account linked successfully!'
    ...
    loading.value = false
    error.value = err instanceof Error ? err.message : 'Failed to link OneDrive account'
