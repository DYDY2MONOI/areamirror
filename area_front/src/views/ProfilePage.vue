              ...
              >
                <div class="account-header">
                  <div class="account-icon" :style="{ backgroundColor: service.color }">
                    ...
                    <svg v-else-if="service.icon === 'facebook'" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                    <svg v-else-if="service.icon === 'onedrive'" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12.5 5.5c2.3 0 4.3 1.3 5.3 3.2.9-.3 1.9-.5 2.9-.4 2.8.3 5 2.7 5 5.5 0 3-2.5 5.5-5.5 5.5H7c-3.3 0-6-2.7-6-6 0-3 2.2-5.5 5.1-5.9C7 4.8 9.5 3 12.5 3c.6 0 1.2.1 1.8.2-.6.7-1 1.6-1.3 2.5-.2 0-.3-.2-.5-.2zm7.7 4.3c-.8 0-1.5.2-2.2.5-.3-1.9-1.4-3.5-2.9-4.5.8-1.1 2.1-1.8 3.6-1.8 2.5 0 4.5 2 4.5 4.5 0 .5-.1.9-.2 1.3h-2.8z"/>
                    </svg>
                    <svg v-else-if="service.icon === 'twitter'" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
